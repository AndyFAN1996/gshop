<template>
    <div class="shop-header">
        ...
        <div class="shop-header-discounts" v-if="info.supports" @click="activityShow=!activityShow"> 
            <div class="discounts-left"> 
                <div class="activity" :class="supports[info.supports[0].type]"> 
                    <span class="content-tag"> 
        ...
        <div class="activity-sheet" v-show="activityShow"> 
            <div class="activity-sheet-content"> 
                ...
                <ul class="list"> 
                    <li class="activity-item" v-for="(support,index) in info.supports" :key="index" :class="supports[support.type]"> 
                        <span class="content-tag"> 
                ...
                <div class="activity-sheet-close"> 
                    <span class="iconfont icon-close" @click="activityShow=!activityShow"></span> 
                </div> 
            </div> 
...
export default {
    data(){
        return {
            supports:['activity-green','activity-red','activity-orange'],
            shopShow:false,
            activityShow:false
        }
    },
