    ...
    <div class="shop-info"> 
        <div class="info-content"> 
            ...
            <section class="section"> 
                ...
                <div class="activity"> 
                    <div class="activity-item" :class="acticityList[support.type]" v-for="(support,index) in info.supports" :key="index"> 
...
export default {
    data(){
        return{
            acticityList:['activity-green','activity-red','activity-orange']
        }
    },
    computed:{
        ...mapState(['info'])
